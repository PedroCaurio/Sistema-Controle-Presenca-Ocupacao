        ...
        if m[0] == "0":
            ...
            if m[1] == "0":                                    
                ...
                if m[2] == '0':
                    ...
                    display.fill_rect(1, 18, 127, 43, 1)
                    display.text('BEM VINDO', 30, 24, 0 )
                    display.text('SEGURANCA!', 28, 36, 0 )
                    fecho(1)
                    display.show()
                    cliente.publish(inic, "{}".format(sala))
                    sleep_ms(4000)
                    ...
                    display.fill_rect(1, 18, 127, 43, 1)
                    display.text('BEM VINDO', 30, 24, 0 )
                    display.text('VISITANTE!', 28, 36, 0 )
                    display.show()
                    cliente.publish(inic, "{}".format(sala))
                    sleep_ms(4000)
                elif m[2] == '4':
                ...
                if m[2] == '0':
                    ...
                    display.fill_rect(1, 18, 127, 43, 1)
                    display.text('ADEUS', 45, 24, 0 )
                    display.text('SEGURANCA!', 25, 36, 0 )
                    display.show()
                    cliente.publish(inic, "{}".format(sala))
                    fecho(0)
                    sleep_ms(4000)
                    ...
                    display.fill_rect(1, 18, 127, 43, 1)
                    display.text('ADEUS', 45, 24, 0 )
                    display.text('VISITANTE!', 25, 36, 0 )
                    display.show()
                    cliente.publish(inic, "{}".format(sala))
                    sleep_ms(4000)
                 elif m[2] == '4':
            ...
            display.fill_rect(1, 18, 127, 43, 1)
            display.text('REGISTRO', 22, 24, 0 )
            display.text('IMCOMPLETO', 17, 36, 0)
            sleep_ms(2000)
